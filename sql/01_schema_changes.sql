...
-- Rename grp.lifespan.description to grp.lifespan.type
ALTER TABLE grp.lifespan
  RENAME COLUMN description TO "type";

-- Add definition and notes columns to: 
-- application_method
ALTER TABLE grp.application_method
  ADD definition text,
  ADD notes text;

-- bed_material
ALTER TABLE grp.bed_material
  ADD definition text,
  ADD notes text;
  
-- bed_prep
ALTER TABLE grp.bed_prep
  ADD definition text,
  ADD notes text;
  
-- disturbance
ALTER TABLE grp.disturbance
  ADD definition text,
  ADD notes text;
  
-- erosion_control
ALTER TABLE grp.erosion_control
  ADD definition text,
  ADD notes text;
  
-- fertilization
ALTER TABLE grp.fertilization
  ADD definition text,
  ADD notes text;
  
-- grazer
ALTER TABLE grp.grazer
  ADD definition text,
  ADD notes text;
  
-- growth_medium
ALTER TABLE grp.growth_medium
  ADD definition text,
  ADD notes text;
  
-- herbicide
ALTER TABLE grp.herbicide
  ADD definition text,
  ADD notes text;
  
-- invasion_control
ALTER TABLE grp.invasion_control
  ADD definition text,
  ADD notes text;
...
-- pretreatment
ALTER TABLE grp.pretreatment
  ADD definition text,
  ADD notes text;
  
-- vegmetric
ALTER TABLE grp.vegmetric
  ADD definition text,
  ADD notes text;
...
-- Update data_dictionary.dictionaryid to auto-generate
ALTER TABLE grp.data_dictionary
ALTER COLUMN dictionaryid
