### This is to import GAZP5 into the SQL database from the Excel format
### It will be a fourth draft of the larger import process
### The update here will be adding paper_author and project_paper staging tables, and updating the project_data_accessibility table to include data independent of the paper
...
# Individual sheets
study <- read.xlsx("data/harmonized/GAZP/GAZP5/GAZP5.xlsx", sheet = "study")
site <- read.xlsx("data/harmonized/GAZP/GAZP5/GAZP5.xlsx", sheet = "site")
treatments <- read.xlsx("data/harmonized/GAZP/GAZP5/GAZP5.xlsx", sheet = "treatments")
timepoints <- read.xlsx("data/harmonized/GAZP/GAZP5/GAZP5.xlsx", sheet = "timepoints")
trtrates <- read.xlsx("data/harmonized/GAZP/GAZP5/GAZP5.xlsx", sheet = "trtrates")
refs <- read.xlsx("data/harmonized/GAZP/GAZP5/GAZP5.xlsx", sheet = "refs")
vegresults <- read.xlsx("data/harmonized/GAZP/GAZP5/GAZP5.xlsx", sheet = "vegresults")
...
data_doi <- "10.5061/dryad.b91t7"
data_url <- "https://datadryad.org/dataset/doi:10.5061/dryad.b91t7"
  ...
  left_join(
    refs |>
      transmute(
        ...
        data_accessibility_notes = data_accessibility_notes
      ) |>
      distinct(),
...
### GAZP5 - transform back to original density values
stg_veg_result <- stg_veg_result |>
  mutate(response = response * 210.22)
...
crosswalk_dir <- "crosswalk_tables/GAZP/GAZP5"
dir.create(crosswalk_dir, recursive = TRUE, showWarnings = FALSE)

write_csv(
  harmonized_SQL_crosswalk,
  file.path(crosswalk_dir, "GAZP5_harmonized-SQL_crosswalk.csv")
)
...
# Crosswalk table
upload_to_supabase(
  local_file = "crosswalk_tables/GAZP/GAZP5/GAZP5_harmonized-SQL_crosswalk.csv",
  destination_path = "GAZP/GAZP5/crosswalks/GAZP5_harmonized-SQL_crosswalk.csv",
...
upload_to_supabase(
  local_file =
    "data/harmonized/GAZP/GAZP5/GAZP5.xlsx",

  destination_path =
    "GAZP/GAZP5/harmonized/GAZP5.xlsx",
...
upload_to_supabase(
  local_file =
    "data/source/GAZP/GAZP5/montana+weather+data.csv",

  destination_path =
    "GAZP/GAZP5/source/montana+weather+data.csv",
...
upload_to_supabase(
  local_file =
    "data/source/GAZP/GAZP5/rec+history.xlsx",

  destination_path =
    "GAZP/GAZP5/source/rec+history.xlsx",
...
upload_to_supabase(
  local_file =
    "data/source/GAZP/GAZP5/seed+mixes+shrub+project.xlsx",

  destination_path =
    "GAZP/GAZP5/source/seed+mixes+shrub+project.xlsx",
...
upload_to_supabase(
  local_file =
    "data/source/GAZP/GAZP5/veg.xlsx",

  destination_path =
    "GAZP/GAZP5/source/veg.xlsx",
...
upload_to_supabase(
  local_file =
    "R/import_code/GAZP5/20260727_GAZP5_import.r",

  destination_path =
    "GAZP/GAZP5/code/20260727_GAZP5_import.r",
